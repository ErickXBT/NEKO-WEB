  ...
  return (
    <section className="py-32 bg-primary text-white text-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h2 className="text-6xl md:text-8xl font-['Bebas_Neue'] mb-6">GET STARTED WITH HOSHI WALLET</h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="flex items-center gap-3 bg-black text-white px-8 py-4 rounded-full font-bold hover:bg-neutral-800 transition-transform hover:scale-105 active:scale-95 w-full sm:w-auto justify-center">
            <Play className="w-5 h-5" /> ANDROID
          </button>
          <button className="flex items-center gap-3 bg-black text-white px-8 py-4 rounded-full font-bold hover:bg-neutral-800 transition-transform hover:scale-105 active:scale-95 w-full sm:w-auto justify-center">
            <Apple className="w-5 h-5" /> IOS APP
          </button>
          <button className="flex items-center gap-3 bg-white text-primary px-8 py-4 rounded-full font-bold hover:bg-neutral-100 transition-transform hover:scale-105 active:scale-95 w-full sm:w-auto justify-center">
